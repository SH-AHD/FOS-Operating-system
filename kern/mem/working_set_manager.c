...
{
	struct WorkingSetElement *New_WS_ELMENT = kmalloc(sizeof(struct WorkingSetElement));
	New_WS_ELMENT->virtual_address=(unsigned int)virtual_address;
  return New_WS_ELMENT;
}
